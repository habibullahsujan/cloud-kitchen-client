              ...
              {user ? (
                ...
                >
                  <svg
                    ...
                    className={`w-6 h-8 fill-current dark:text-violet-400 ${commentActive && 'text-orange-400'}`}
                  >
              ...
              {user ? (
                ...
                >
                  <svg
                    ...
                    className={`w-6 h-8 fill-current dark:text-violet-400 ${likeActive && 'text-orange-400'}`}
                  >
